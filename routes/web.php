    ...
    Route::post('postEmailVerify', [UserController::class, 'postEmailVerify'])->name('send.email-verify');     
        Route::group(['middleware'=>'auth:user'], function() {
            Route::middleware(['Blocked', 'CheckStatus', 'Kyc', 'Tfa'])->group(function () {
                ...
                Route::get('manual_transfer/{id}', [UserController::class, 'manual_transfer'])->name('user.manual_transfer');
                Route::post('manual_transfer', [UserController::class, 'manual_transfersubmit'])->name('manual_transfersubmit');
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin'], function () {
    ...
    Route::get('manual_transfer/delete/{id}', [DepositController::class, 'DestroyManual'])->name('manualtransfer.delete');
    ...
    Route::get('create-manual-deposit', [DepositController::class, 'createManual'])->name('admin.deposit.manual.create');
    Route::get('manual-deposit', [DepositController::class, 'manual'])->name('admin.deposit.manual');
    Route::post('store-manual-deposit', [DepositController::class, 'storeManual'])->name('admin.deposit.manual.store');
    Route::post('update-manual-deposit', [DepositController::class, 'updateManual'])->name('admin.deposit.manual.update');
    ...
    Route::get('approvemt/{id}', [DepositController::class, 'approvemt'])->name('deposit.approvemt');
    Route::get('declinemt/{id}', [DepositController::class, 'declinemt'])->name('deposit.declinemt');

      ...
      @foreach ($manuals as $val)
        <div class="col-md-3">
          <div class="card">
            ...
            <div class="card-body">
              <div class="row align-items-center">
                <a href="{{route('user.manual_transfer', $val->id)}}">
                  <div class="col-md-6">
                    <h4 class="mb-1 text-dark">
                      <a href="{{route('user.manual_transfer', $val->id)}}">{{$val->name}}</a>
                    </h4>
                    <p class="text-sm text-dark mb-0">{{__('Wallet')}}: {{$val->wallet}}</p>
                  </div>
                  <div class="col-md-6">
                    <span class="btn-inner--icon"><img src="{{url('/')}}/asset/manual/{{$val->icon}}" height="50" width="100"></span>
                  </div>
                </a>
              </div>
            </div>
                  ...
                  <div class="card-header bg-transparent pb-5">
                    <div class="btn-wrapper text-center">
                      <a href="javascript:void;" class="btn btn-neutral btn-icon">
                        <span class="btn-inner--icon"><img src="{{url('/')}}/asset/manual/{{$val->icon}}"></span>
                      </a>
                    </div>
                  </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row align-items-center">
                ...
                <div class="col-md-6">
                  <span class="btn-inner--icon"><img src="{{url('/')}}/asset/payment_gateways/{{$val->gateimg}}" height="50" width="100"></span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="table-responsive py-4">
        <table class="table table-flush" id="datatable-basic2">
          <thead class="">
            ...
            <tbody>  
            @foreach($manual_transfer as $k=>$val)
              <tr>
                <td>{{++$k}}.</td>
                <td>#{{$val->trx}}</td>
                <td>{{$currency->symbol.number_format($val->amount)}}</td>

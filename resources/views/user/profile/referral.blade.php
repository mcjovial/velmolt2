      ...
      <div class="col-lg-4">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <span class="form-text text-dark text-sm">{{env('APP_URL')}}/register?ref={{$user->username}}</span>
            <button type="button" class="btn-icon-clipboard" data-clipboard-text="{{env('APP_URL')}}/register?ref={{$user->username}}" title="Copy">{{__('Copy')}}</button>
          </div>
        </div>
        @endif
          <div class="card">

                ...
                <div class="pricing-table bg-white">
                    <div class="pricing-header pricing-amount">
                        ...
                        <div class="small_desc text-center">
                            ...
                            @endif
                            @if($val->claim==1) <span class="castrooo">{{__('Access to Profit anytime')}} </span><br>@else <span class="castrooo">{{__('Access to profit at end of plan')}} </span><br>@endif
                            @if($val->recurring==1) <span class="castrooo">{{__('Recurring capital investment')}} </span><br>@else <span class="castrooo">{{__('No recurring capital investment')}} </span><br>@endif
                        </div>
                    </div>
                </div>
            </div>

      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <li class="nav-item">
              ...
              <div class="collapse @if(route('admin.deposit.method')==url()->current() || route('admin.banktransfer')==url()->current() || route('admin.deposit.log')==url()->current()) show @endif" id="card">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item @if(route('admin.deposit.manual')==url()->current()) active @endif"><a href="{{route('admin.deposit.manual')}}" class="nav-link">{{__('Manual Payment gateways')}}</a></li>
          ...
          <ul class="navbar-nav mb-md-3"> 
            ...
            <li class="nav-item">
              <a class="nav-link @if(route('admin.currency')==url()->current()) active @endif text-dark" href="{{route('admin.currency')}}">
                <i class="fad fa-money-bill-wave-alt" style="color: {{$set->s_c}};"></i>
